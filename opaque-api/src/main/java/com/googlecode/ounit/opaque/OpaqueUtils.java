...
public class OpaqueUtils {
    ...
    /**
     * The student has requested that the responses should be saved but not
     * submitted or validated
     */
    public static final int MOODLE_EVENTSAVE = 2;
    /**
     * Moodle has graded the responses. A CLOSE event can be changed to a
     * CLOSEANDGRADE event by Moodle.
     */
     ...
     * Opaque sees this event when quiz runs in "adaptive" mode and student hits
     * "submit this page"
     */
    public static final int MOODLE_EVENTSUBMIT = 7;
    /**
     * The response has been submitted and the session has been closed, either
     * because the student requested it or because Moodle did it (e.g. because
     * of a timelimit). The responses have not been graded.
     */
     ...
     * @param resourceNames an array of resource fileNames already present on
     * client
    ...
    /**
     * Format an array to a string representation. Eg [1, 2, 3] Useful for
     * debugging.
     *
     * @param arr arr
     * @return String
