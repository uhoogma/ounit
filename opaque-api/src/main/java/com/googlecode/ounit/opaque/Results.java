...
public class Results {
    ...
    /**
     * Stores information about the number of attempts taken to get question
     * right (1=first time)
     */
     ...
     * ATTEMPTS_PASS(0)=user passed, ATTEMPTS_WRONG(-1)=user failed all
     * attempts, ATTEMPTS_UNSET(-99)=value has not been set
     */
     ...
     * However, some questions may be impossible to accurately summarise in a
     * single line.
     *
     ...
     * gave. In some cases this may be impossible, for reasons of length or the
     * text-only format.
     *
    ...
    /**
     * @see #appendActionSummary(String) preliminary description
     * @param actionSummary preliminary description
     */
     ...
     * question right on the third try, this would typically include the first
     * and second answers too. It is not restricted in length (though shouldn't
     * be ridiculous) and may contain any other information about the question
     * that should be recorded for easy access by admin staff.
     *
     ...
     * if setting score on individual axes; can be set as part of setScore for
     * single-axis results.
     *
     * @param iAttempts 1 = user got question right on first attempt, etc.; or
     * use an ATTEMPTS_xx constant
     */
